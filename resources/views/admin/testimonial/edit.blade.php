    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header justify-content-between">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin_testimonial_index') }}" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_testimonial_edit_submit',$testimonial->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div><img src="{{ asset('uploads/'.$testimonial->photo) }}" class="w_200"></div>
                                    </div>
                                    <div class="mb-3">
