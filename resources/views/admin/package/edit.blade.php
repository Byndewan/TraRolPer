                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_package_edit_submit',$package->id) }}" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div><img src="{{ asset('uploads/'.$package->featured_photo) }}" class="w_200"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Banner</label>
                                                <div><img src="{{ asset('uploads/'.$package->banner) }}" class="w_200"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="map" class="form-control h_200" cols="30" rows="10">{{ $package->map }}</textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Minimal Pemesanan</label>
                                        <input type="text" class="form-control" name="min_person"
                                            value="{{ $package->min_person }}">
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Maksimal Pemesanan</label>
